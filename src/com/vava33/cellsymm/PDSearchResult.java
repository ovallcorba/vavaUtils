...
public class PDSearchResult implements Comparable<PDSearchResult>{
    ...
    public String toString(){
        return String.format("%7.3f  %d/%d  %s  [%s] (aka: %s)",this.getTotal_residual(),nDSPin,this.getC().getNrRefUpToDspacing(minDSPin),this.getC().getCompNames().get(0),this.getC().getFormula(),this.getC().getAltNames());
    }
}
